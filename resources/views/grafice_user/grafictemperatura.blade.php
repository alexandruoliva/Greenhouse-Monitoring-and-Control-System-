...
$result =mysqli_query ($con,"SELECT  (UNIX_TIMESTAMP(time)*1000) AS time, temperature FROM temps");
...
<html>
<title>Temperature Graphic Data visualization</title>
...
<br/>
    ...
    <h2 class="text-center">Temperature Sensor  🌡️</h2>
<div class="row">
...
<script type="text/javascript">
    ...
    function (data) {
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Temperature sensor data over time'
            },
            subtitle: {
            ...
            yAxis: {
                title: {
                    text: 'Value of the temperature[°C]'
                }
            },
            legend: {
                enabled: false
