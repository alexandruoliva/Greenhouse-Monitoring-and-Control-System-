...
$result =mysqli_query ($con,"SELECT  (UNIX_TIMESTAMP(time)*1000) AS time, light FROM lights");
...
<html>
<title>Light Graphic Data visualization</title>
...
<br/>
    ...
    <h2 class="text-center">Light Sensor  ☀️</h2>
<div class="row">
...
<script type="text/javascript">
    ...
    function (data) {
        ...
        Highcharts.chart('container', {
            ...
            title: {
                text: 'Light sensor data over time'
            },
            subtitle: {
